...
def process_data(data):
  ...
  best_year, best_sales = popular_car_year

  summary = [
    "The {} generated the most revenue: ${}".format(format_car(max_revenue["car"]), max_revenue["revenue"]),
    "The {} had the most sales: {}".format(format_car(max_sales["car"]), max_sales["total_sales"]),
    "The most popular year was {} with {} sales.".format(best_year, best_sales)
  ]
...
def main(argv):
  ...
  body = "\n".join(summary)
  dir = "/tmp/cars.pdf"
  message = emails.generate(sender, recipient, subject, body, dir)
  emails.send(message)
